...
from core.exceptions import (AppException, AuthenticationError, ConflictError,
...
class ErrorResponse:
    ...
    def __init__(
        self, status_code: str = "error", error: str = "", data: Optional[Any] = None
    ):
...
def handle_api_error(
    ...
    if hasattr(error, "message"):
        ...
        if any(
            ...
            for phrase in ["Invalid JWT", "JWT expired", "Unauthorized"]
        ):
        ...
        # Conflict errors (duplicate data)
            ...
            for phrase in ["already exists", "duplicate", "conflict"]
        ):
        ...
        # Other external service errors
            ...
            if return_error_response:
                ...
                return HTTPException(
                    ...
                    detail={
                        "message": external_error.message,
                        "details": external_error.details,
                    },
                )
